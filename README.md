...
### 我的博客：
- [hexo 个性化博客](http://lhx.cool/)（综合性博客，包括面经、Java笔记、Java学习框架、算法等等）
...
- [自建博客](http://120.76.217.185:8080/classfication)（个人搭建的服务器博客项目、使用Nginx反向代理接口服务，博客放了一些个人刷过的 `leetcode` 算法常见题型，对移动端使用人群友好）
