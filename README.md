...
- [自建博客-镜像1](http://120.76.217.185:8080/classfication)（个人搭建的服务器博客项目、使用`Nginx`反向代理接口服务，博客放了一些个人刷过的 `leetcode` 算法常见题型，对移动端使用人群友好）、[自建博客-镜像2](http://139.159.185.83:8080/classfication)（华为云2核免费一个月搭建）、[自建博客-镜像3](http://121.37.12.67/classfication)（华为4核搭建、nginx负载、宕机重启） 
